...
class Float{
	...
	public:
		...
		unsigned long long operator >=(Tree<Float> &);
...
float Float::ret_obj(void)
	{ return (this->object);
}

void Float::operator = (int32_t val) {
...
unsigned long long Float::operator >=(Tree<Float> &t) {
...
Float obj;
   ...
   std::default_random_engine eng((std::random_device())());
        std::uniform_real_distribution<float> idis(0, 10000000.0);
